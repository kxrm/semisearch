...
impl LightweightAnalyzer {
    ...
    fn calculate_char_perplexity(&self, text: &str) -> f32 {
        ...
        for window in chars.windows(3) {
            ...
            let log_prob = self.char_stats.trigram_log_probs
                .get(&key)
                .copied()
                .unwrap_or(-100) as f32 / 10.0; // Dequantize
    ...
    fn combine_scores(
        ...
        let has_question_word = ["how", "what", "why", "when", "where", "which", "who", "does", "can", "should", "would"]
            .iter()
    ...
    fn detect_concepts(&self, tokens: &[Token]) -> f32 {
        ...
        for token in tokens {
            ...
            if token.original.chars().next().map_or(false, |c| c.is_uppercase()) {
                concept_score += 0.3;
            }
    ...
    pub fn explain_analysis(&self, query: &str) {
        ...
        println!("├─ Character Perplexity: {:.2} (lower = more common patterns)", char_perplexity);
        println!("├─ Semantic Weight:      {:.2} (higher = richer vocabulary)", semantic_weight);
        println!("├─ Token Coherence:      {:.2} (higher = better relationships)", coherence);
        println!("├─ Concept Density:      {:.2} (higher = more entities/concepts)", concept_density);
        println!("└─ Token Count:          {}", tokens.len());
        
        if tokens.len() > 0 {
            println!("\nToken Analysis:");
            for token in &tokens {
                let token_score = if let Some(&w) = self.token_stats.semantic_indicators.get(&token.hash) {
                    w as f32 / 255.0
                } else {
                    self.analyze_oov_token(&token.text)
                };
                println!("  '{}' → semantic weight: {:.2}", token.original, token_score);
            }
        }
    }
}
...
pub fn build_analyzer_with_defaults() -> LightweightAnalyzer {
    ...
    let common_trigrams = vec![
        (b"the", 30), (b"and", 25), (b"ing", 28), (b"ion", 26),
        (b"tio", 24), (b"ent", 23), (b"ati", 22), (b"for", 25),
        (b"her", 24), (b"ter", 23), (b"hat", 22), (b"tha", 21),
        (b"ere", 23), (b"ate", 22), (b"his", 24), (b"con", 22),
        (b"res", 21), (b"ver", 22), (b"all", 23), (b"ons", 21),
        (b"nce", 20), (b"men", 21), (b"ith", 22), (b"ted", 21),
        (b"ers", 22), (b"pro", 21), (b"thi", 23), (b"wit", 21),
        (b"are", 24), (b"ess", 20), (b"not", 22), (b"ive", 21),
        (b"was", 23), (b"ect", 20), (b"rea", 21), (b"com", 22),
        (b"eve", 20), (b"per", 21), (b"int", 22), (b"est", 23),
        (b"sta", 21), (b"cti", 20), (b"ica", 19), (b"ist", 20),
    ];
    ...
    let semantic_words = vec![
        // Conceptual terms
        ("relationship", 200), ("concept", 190), ("theory", 185),
        ("analysis", 180), ("structure", 175), ("pattern", 170),
        ("framework", 180), ("model", 175), ("system", 170),
        ("process", 165), ("method", 160), ("approach", 165),
        
        // Abstract terms
        ("understanding", 180), ("meaning", 175), ("context", 170),
        ("interpretation", 185), ("significance", 180), ("implication", 175),
        
        // Academic/technical
        ("algorithm", 190), ("implementation", 185), ("architecture", 180),
        ("optimization", 185), ("evaluation", 175), ("performance", 170),
        
        // Relational
        ("between", 150), ("among", 145), ("through", 140),
        ("within", 145), ("across", 140), ("regarding", 150),
        
        // Objects/entities (often need context)
        ("object", 160), ("entity", 165), ("component", 170),
        ("element", 155), ("feature", 160), ("attribute", 165),
        ("property", 170), ("characteristic", 175),
        
        // Actions that suggest complex queries
        ("analyze", 180), ("compare", 175), ("evaluate", 170),
        ("determine", 165), ("identify", 160), ("examine", 165),
        ("investigate", 170), ("explore", 165),
        
        // Question words (often semantic)
        ("how", 140), ("why", 145), ("what", 135), ("when", 130),
        ("where", 130), ("which", 135), ("who", 125),
        
        // Technical concepts
        ("memory", 165), ("cache", 160), ("database", 170),
        ("network", 165), ("security", 170), ("authentication", 175),
        ("authorization", 175), ("encryption", 170), ("protocol", 165),
        ("interface", 160), ("function", 155), ("class", 150),
        ("inheritance", 170), ("polymorphism", 180), ("abstraction", 175),
        
        // Process words
        ("management", 170), ("handling", 165), ("processing", 160),
        ("execution", 165), ("operation", 160), ("transaction", 165),
        ("synchronization", 180), ("coordination", 175), ("integration", 170),
        
        // Comparative/evaluative
        ("difference", 175), ("similarity", 170), ("comparison", 175),
        ("contrast", 170), ("versus", 165), ("alternative", 170),
        ("option", 150), ("choice", 155), ("decision", 160),
        
        // Impact/effect words
        ("impact", 170), ("effect", 165), ("influence", 170),
        ("cause", 160), ("result", 155), ("consequence", 170),
        ("implication", 175), ("outcome", 165), ("affect", 165),
        
        // Complex concepts
        ("complexity", 175), ("scalability", 180), ("reliability", 175),
        ("availability", 170), ("consistency", 175), ("concurrency", 180),
        ("latency", 170), ("throughput", 165), ("bottleneck", 170),
        
        // Design/architecture
        ("design", 170), ("principle", 175), ("practice", 165),
        ("strategy", 170), ("technique", 165), ("methodology", 175),
        ("paradigm", 180), ("philosophy", 175),
        
        // Problem-solving
        ("problem", 165), ("solution", 160), ("issue", 155),
        ("challenge", 170), ("difficulty", 165), ("debugging", 170),
        ("troubleshooting", 175), ("resolving", 165),
        
        // Data concepts
        ("data", 150), ("information", 160), ("storage", 155),
        ("retrieval", 165), ("query", 145), ("search", 150),
        ("index", 145), ("structure", 170), ("organization", 165),
        
        // System concepts
        ("distributed", 180), ("centralized", 175), ("decentralized", 180),
        ("asynchronous", 185), ("synchronous", 180), ("parallel", 175),
        ("concurrent", 180), ("sequential", 170), ("reactive", 175),
        
        // Auxiliary verbs that indicate complex queries
        ("does", 120), ("can", 115), ("should", 125), ("would", 120),
        ("could", 120), ("might", 115), ("must", 125), ("will", 110),
        
        // Common programming terms
        ("programming", 160), ("coding", 155), ("development", 165),
        ("software", 160), ("hardware", 155), ("application", 160),
        ("program", 150), ("code", 145), ("script", 140),
        ("language", 155), ("syntax", 160), ("semantics", 175),
        
        // More technical concepts  
        ("concept", 170), ("principle", 175), ("fundamental", 170),
        ("basic", 130), ("advanced", 165), ("intermediate", 155),
        ("beginner", 140), ("expert", 160), ("professional", 155),
        
        // Common tech domains
        ("web", 140), ("mobile", 145), ("desktop", 140),
        ("server", 145), ("client", 140), ("frontend", 150),
        ("backend", 150), ("fullstack", 155), ("devops", 160),
        
        // Common question phrases
        ("causes", 160), ("reasons", 165), ("factors", 160),
        ("considerations", 170), ("implications", 175), ("consequences", 170),
        ("benefits", 155), ("drawbacks", 160), ("advantages", 155),
        ("disadvantages", 160), ("pros", 145), ("cons", 145),
        
        // Analysis terms
        ("analyzing", 170), ("evaluating", 170), ("assessing", 165),
        ("investigating", 170), ("exploring", 165), ("examining", 165),
        ("reviewing", 160), ("studying", 165), ("researching", 170),
    ];
    ...
    LightweightAnalyzer {
        ...
        subword_patterns: SubwordPatterns {
            concept_affixes: vec![
                ("tion", 180), ("ment", 170), ("ness", 160),
                ("able", 150), ("ize", 140), ("ify", 140),
                ("ology", 200), ("graphy", 190), ("metry", 185),
                ("ism", 160), ("ist", 155), ("ity", 150),
                ("ance", 145), ("ence", 145), ("ship", 155),
                ("ful", 130), ("less", 130), ("ward", 125),
            ],
            entity_patterns,
        },
...
mod tests {
    ...
    fn test_size_estimates() {
        ...
        let analyzer = build_analyzer_with_defaults();
